...
public class CartServiceImpl implements CartService {
    ...
    public CartSaveResponse save(String loginId, Long productId) {
        ...
        {
            throw new ClientException(ErrorCode.MEMBER_NOT_FOUND, "this member login id is not found");
        });
    ...
    @Override
    public Optional<Cart> findById(Long memberId, Long productId) {
        return jpaCartCommonRepository.findByMember_MemberIdAndProduct_ProductId(memberId, productId);
    }
